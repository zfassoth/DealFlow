...
function fallbackMessage(c, profile = {}) {
  ...
  if (c.status === "Sold") return `Hey ${first}, ${intro}Hope you're still loving your ${vehicle}. If you know anyone starting to look for a vehicle, I'd really appreciate you sending them my way. I'll take great care of them.${signoff}`;
